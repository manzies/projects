...
public class PreRelease2016Extension {
	...
	static void blankLine() { // Function blankLine
		System.out.println (); // Output a blank line		
	}
	
	static int subtraction(int x, int y) { // Function subtraction
		return x - y;
	}
	public static void main (String[]args) {
		...
		finalPrice = (subtraction(totalPrice, discountAmount));
		System.out.println ("Discount price: $" + finalPrice);
		amountSaved = (subtraction(totalPrice,finalPrice));
